...
public class ADRoman {
    ...
    /** translation-key prefix vanilla uses for enchantment level display, e.g. {@code "enchantment.level.5"} */
    ...
    /** converts an integer to its Roman numeral representation using a greedy algorithm */
    public static String toRoman(int num) {
        if (num <= 0) return "";
        if (num > MAX_ROMAN) num = MAX_ROMAN;
